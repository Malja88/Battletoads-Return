...
public class PatrolingScriptWithRandomAttacks : MonoBehaviour
{
    ...
    /// <summary>
    /// Patroling certain space on scene
    /// </summary>
    public void Patroling()
    {
        ...
        if (walkRandom)
        {
            if (waypointIndex <= walkingPoint.Length - 1)
            {
                ...
                if (transform.position == walkingPoint[walkingPointEnd].transform.position)
                {
                    waypointIndex = 0;
                }
